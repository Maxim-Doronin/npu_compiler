...
//CHECK-NEXT: VPUASM.DeclareTaskBuffer @[[TB10:.+]] idx(!VPURegMapped.Index<0:1:0>) <DMA>
...
//CHECK: ELF.CreateSection @[[SECDMA01:.+]] aligned
//CHECK-NEXT: VPUASM.NNDMA @[[SYMDMA12:.+]] idx(!VPURegMapped.Index<0:1:2>)
    //CHECK-SAME: taskLocation(@[[SECMETA]]::@[[TB12]]) input(@[[SECCMX1]]::@[[SYMBUF4]]) outputs([@[[SECOUT1]]::@[[SYMBUF2]]]) waits([1 : ui8]) updates([]) start_after(0)
    //CHECK-SAME: dma_descriptor(<numPlanes = 0 : i4, len = 0 : i4, srcWidth = 0 : i4, srcStride = 0 : i4, srcPlaneStride = 0 : i4, dstWidth = 0 : i4, dstStride = 0 : i4, dstPlaneStride = 0 : i4>)

//CHECK-NEXT: VPUASM.NNDMA @[[SYMDMA11:.+]] idx(!VPURegMapped.Index<0:1:1>)
    //CHECK-SAME: taskLocation(@[[SECMETA]]::@[[TB11]]) links(@[[SECDMA01]]::@[[SYMDMA12]]) input(@[[SECIN0]]::@[[SYMBUF0]]) outputs([@[[SECCMX1]]::@[[SYMBUF4]]]) waits([0 : ui8]) updates([1 : ui8]) start_after(0)
    //CHECK-SAME: dma_descriptor(<numPlanes = 0 : i4, len = 0 : i4, srcWidth = 0 : i4, srcStride = 0 : i4, srcPlaneStride = 0 : i4, dstWidth = 0 : i4, dstStride = 0 : i4, dstPlaneStride = 0 : i4>)

//CHECK-NEXT: VPUASM.NNDMA @[[SYMDMA10:.+]] idx(!VPURegMapped.Index<0:1:0>)
    //CHECK-SAME: taskLocation(@[[SECMETA]]::@[[TB10]]) links(@[[SECDMA01]]::@[[SYMDMA11]]) input(@[[SECIN0]]::@[[SYMBUF0]]) outputs([@[[SECCMX1]]::@[[SYMBUF4]]]) waits([]) updates([0 : ui8]) start_after(0)
    //CHECK-SAME: dma_descriptor(<numPlanes = 0 : i4, len = 0 : i4, srcWidth = 0 : i4, srcStride = 0 : i4, srcPlaneStride = 0 : i4, dstWidth = 0 : i4, dstStride = 0 : i4, dstPlaneStride = 0 : i4>)

//CHECK: ELF.CreateSection @[[SECDMA00:.+]] aligned
//CHECK-NEXT: VPUASM.NNDMA @[[SYMDMA02:.+]] idx(!VPURegMapped.Index<0:0:2>)
    //CHECK-SAME: taskLocation(@[[SECMETA]]::@[[TB02]]) input(@[[SECCMX0]]::@[[SYMBUF3]]) outputs([@[[SECOUT0]]::@[[SYMBUF1]]]) waits([1 : ui8]) updates([]) start_after(0)
    //CHECK-SAME: dma_descriptor(<numPlanes = 0 : i4, len = 0 : i4, srcWidth = 0 : i4, srcStride = 0 : i4, srcPlaneStride = 0 : i4, dstWidth = 0 : i4, dstStride = 0 : i4, dstPlaneStride = 0 : i4>)

//CHECK-NEXT: VPUASM.NNDMA @[[SYMDMA01:.+]] idx(!VPURegMapped.Index<0:0:1>)
    //CHECK-SAME: taskLocation(@[[SECMETA]]::@[[TB01]]) links(@[[SECDMA00]]::@[[SYMDMA02]]) input(@[[SECIN0]]::@[[SYMBUF0]]) outputs([@[[SECCMX0]]::@[[SYMBUF3]]]) waits([0 : ui8]) updates([1 : ui8]) start_after(0)
    //CHECK-SAME: dma_descriptor(<numPlanes = 0 : i4, len = 0 : i4, srcWidth = 0 : i4, srcStride = 0 : i4, srcPlaneStride = 0 : i4, dstWidth = 0 : i4, dstStride = 0 : i4, dstPlaneStride = 0 : i4>)

//CHECK-NEXT: VPUASM.NNDMA @[[SYMDMA00:.+]] idx(!VPURegMapped.Index<0:0:0>)
    //CHECK-SAME: taskLocation(@[[SECMETA]]::@[[TB00]]) links(@[[SECDMA00]]::@[[SYMDMA01]]) input(@[[SECIN0]]::@[[SYMBUF0]]) outputs([@[[SECCMX0]]::@[[SYMBUF3]]]) waits([]) updates([0 : ui8]) start_after(0)
    //CHECK-SAME: dma_descriptor(<numPlanes = 0 : i4, len = 0 : i4, srcWidth = 0 : i4, srcStride = 0 : i4, srcPlaneStride = 0 : i4, dstWidth = 0 : i4, dstStride = 0 : i4, dstPlaneStride = 0 : i4>)

//CHECK: VPUASM.MappedInference_37XX @MappedInference : dmas([@[[SECDMA00]]::@[[SYMDMA00]], @[[SECDMA01]]::@[[SYMDMA10]]]) barriers(@[[SECBAR]]::@[[SYMBARRIER0]])
...
func.func @multiple_clusters_dpu_soh_f16_f16_f16() {
  ...
  %14 = VPUMI37XX.DPUInvariant <{clean_after = 0 : ui64, is_segmented, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  ...
  taskLocation(%2 : !VPURegMapped.Index<0:0:0>) input(%10 : memref<1x32x16x32xf16, #NHWC, [@CMX_NN, 0]>) weights(%4 : memref<64x32x1x1xf16, #NHWC, [@CMX_NN, 0]>)
  weight_table(%12 : memref<64x1x1x4xsi32, #NHWC, [@CMX_NN, 0]>) parent_input(%9 : !VPUIP.DistributedBuffer<1x32x32x32xf16, {order = #NHWC, strides = [32768, 1, 1024, 32]}, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64, alignment = [1, 1, 1, 1]}>) parent_output(%6 : !VPUIP.DistributedBuffer<1x64x32x32xf16, {order = #NHWC, strides = [65536, 1, 2048, 64]}, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%7 : memref<1x64x16x32xf16, #NHWC, [@CMX_NN, 0]>) -> <0:0:0> PPE : {
  }
  %15 = VPUMI37XX.DPUInvariant <{clean_after = 0 : ui64, is_segmented, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
  kernel_size = [1, 1], kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, start_after = 0 : ui64, nce_task_type = #VPUIP.nce_task_type<CONV>}>
  taskLocation(%3 : !VPURegMapped.Index<0:0:1>) input(%11 : memref<1x32x16x32xf16, #NHWC, [@CMX_NN, 1]>) weights(%5 : memref<64x32x1x1xf16, #NHWC, [@CMX_NN, 1]>)
  weight_table(%13 : memref<64x1x1x4xsi32, #NHWC, [@CMX_NN, 1]>) parent_input(%9 : !VPUIP.DistributedBuffer<1x32x32x32xf16, {order = #NHWC, strides = [32768, 1, 1024, 32]}, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64, alignment = [1, 1, 1, 1]}>) parent_output(%6 : !VPUIP.DistributedBuffer<1x64x32x32xf16, {order = #NHWC, strides = [65536, 1, 2048, 64]}, @CMX_NN, {mode = "SEGMENTED", num_tiles = [1, 1, 2, 1], num_clusters = 2 : i64}>) outputs(%8 : memref<1x64x16x32xf16, #NHWC, [@CMX_NN, 1]>) -> <0:0:1> PPE : {
  }
...
//CHECK-NEXT: VPUASM.DPUInvariant_37XX @[[INVARIANTSYM0:.+]] idx(!VPURegMapped.Index<0:0:0>) taskLocation(@[[SECMETA]]::@[[TBIVAR0]])
    // CHECK-SAME: input(@[[SECCMX0]]::@[[SYMBUFF6]]) weights(@[[SECCMX0]]::@[[SYMBUFF0]]) weight_table(@[[SECCMX0]]::@[[SYMBUFF8]]) parent_input(@[[SYMBUFF5]]) parent_output(@[[SYMBUFF2]]) outputs([@[[SECCMX0]]::@[[SYMBUFF3]]])
//CHECK: VPUASM.DPUInvariant_37XX @[[INVARIANTSYM1:.+]] idx(!VPURegMapped.Index<0:0:1>) taskLocation(@[[SECMETA]]::@[[TBIVAR1]])
    // CHECK-SAME: input(@[[SECCMX1]]::@[[SYMBUFF7]]) weights(@[[SECCMX1]]::@[[SYMBUFF1]]) weight_table(@[[SECCMX1]]::@[[SYMBUFF9]]) parent_input(@[[SYMBUFF5]]) parent_output(@[[SYMBUFF2]]) outputs([@[[SECCMX1]]::@[[SYMBUFF4]]])

//CHECK: ELF.CreateSection @[[SECVAR:.+]] aligned
//CHECK-NEXT: VPUASM.DPUVariant_37XX @[[SYMVAR0:.+]] idx(!VPURegMapped.Index<0:0:0>) taskLocation(@[[SECMETA]]::@[[TBVAR0]]) calls @[[SECINV]]::@[[INVARIANTSYM0]]
//CHECK: VPUASM.DPUVariant_37XX @[[SYMVAR1:.+]] idx(!VPURegMapped.Index<0:0:1>) taskLocation(@[[SECMETA]]::@[[TBVAR1]]) calls @[[SECINV]]::@[[INVARIANTSYM1]]

//CHECK: VPUASM.MappedInference_37XX @MappedInference : invariants(@[[SECINV]]::@[[INVARIANTSYM0]]) variants(@[[SECVAR]]::@[[SYMVAR0]]) dmaCount([0, 0]) invariantCount(2) variantCount(2) actKernelRangesCount(0) actKernelInvocationsCount(0) barrierCount(0)
...
func.func @multiple_clusters_dpu_sok_f16_f16_f16() {
  ...
  %22 = VPUMI37XX.DPUInvariant <{clean_after = 0 : ui64, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [1, 1],
  ...
  input(%11 : memref<1x32x16x16xf16, #NHWC, [@CMX_NN, 0]>) weights(%7 : memref<32x32x1x1xf16, #NHWC, [@CMX_NN, 0]>) weight_table(%13 : memref<32x1x1x4xsi32, #NHWC, [@CMX_NN, 0]>)
  parent_input(%10 : !VPUIP.DistributedBuffer<1x32x16x16xf16, {order = #NHWC, strides = [8192, 1, 512, 32]}, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64}>)
  parent_output(%9 : !VPUIP.DistributedBuffer<1x64x16x16xf16, {order = #NHWC, strides = [16384, 1, 1024, 64]}, @CMX_NN, {mode = "DUPLICATED|SEGMENTED", num_tiles = [1, 2, 1, 1], num_clusters = 2 : i64, alignment = [1, 16, 1, 1]}>) outputs(%19, %20 : memref<1x32x16x16xf16, {order = #NHWC, strides = [16384, 1, 1024, 64]}, [@CMX_NN, 0]>, memref<1x32x16x16xf16, {order = #NHWC, strides = [16384, 1, 1024, 64]}, [@CMX_NN, 1]>) -> <0:0:0> PPE : {
  }
  %23 = VPUMI37XX.DPUInvariant <{clean_after = 0 : ui64, kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [1, 1],
  kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, start_after = 0 : ui64, nce_task_type = #VPUIP.nce_task_type<CONV>}> taskLocation(%3 : !VPURegMapped.Index<0:0:1>)
  input(%12 : memref<1x32x16x16xf16, #NHWC, [@CMX_NN, 1]>) weights(%8 : memref<32x32x1x1xf16, #NHWC, [@CMX_NN, 1]>) weight_table(%14 : memref<32x1x1x4xsi32, #NHWC, [@CMX_NN, 1]>)
  parent_input(%10 : !VPUIP.DistributedBuffer<1x32x16x16xf16, {order = #NHWC, strides = [8192, 1, 512, 32]}, @CMX_NN, {mode = "DUPLICATED", num_clusters = 2 : i64}>)
...
//CHECK-NEXT: VPUASM.DeclareBuffer @[[SYMBUFF6:.+]] !VPUASM.Buffer< "CMX_NN"[0] <34816>
...
//CHECK-NEXT: VPUASM.DPUInvariant_37XX @[[SYMINV0:.+]] idx(!VPURegMapped.Index<0:0:0>) taskLocation(@[[SECMETA]]::@[[TBIVAR0]])
    ...
    //CHECK-SAME: parent_input(@[[SYMBUFF5]]) parent_output(@[[SYMBUFF4]]) outputs([@[[SECCMX0]]::@[[SYMBUFF14]], @[[SECCMX1]]::@[[SYMBUFF15]]])

//CHECK: VPUASM.DPUInvariant_37XX @[[SYMINV1:.+]] idx(!VPURegMapped.Index<0:0:1>) taskLocation(@[[SECMETA]]::@[[TBIVAR1]])
    //CHECK-SAME: input(@[[SECCMX1]]::@[[SYMBUFF7]]) weights(@[[SECCMX1]]::@[[SYMBUFF3]]) weight_table(@[[SECCMX1]]::@[[SYMBUFF9]])
    //CHECK-SAME: parent_input(@[[SYMBUFF5]]) parent_output(@[[SYMBUFF4]]) outputs([@[[SECCMX0]]::@[[SYMBUFF14]], @[[SECCMX1]]::@[[SYMBUFF15]]])

//CHECK: ELF.CreateSection @[[SECVAR:.+]] aligned
//CHECK-NEXT: VPUASM.DPUVariant_37XX @[[SYMVAR0:.+]] idx(!VPURegMapped.Index<0:0:0>) taskLocation(@[[SECMETA]]::@[[TBVAR0]]) calls @[[SECINV]]::@[[SYMINV0]]
//CHECK: VPUASM.DPUVariant_37XX @[[SYMVAR1:.+]] idx(!VPURegMapped.Index<0:0:1>) taskLocation(@[[SECMETA]]::@[[TBVAR1]]) calls @[[SECINV]]::@[[SYMINV1]]

//CHECK: VPUASM.MappedInference_37XX @MappedInference : invariants(@[[SECINV]]::@[[SYMINV0]]) variants(@[[SECVAR]]::@[[SYMVAR0]]) dmaCount([0, 0]) invariantCount(2) variantCount(2) actKernelRangesCount(0) actKernelInvocationsCount(0) barrierCount(0)
