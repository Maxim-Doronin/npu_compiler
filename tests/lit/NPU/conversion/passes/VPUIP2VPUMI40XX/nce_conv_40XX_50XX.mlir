...
//CHECK-LABEL: func.func private @multiple_clusters_dpu_sok_f16_f16_f16
...
//CHECK-NOT: VPURT.Task
//CHECK-NEXT: VPUMI40XX.NNDMA{{.+}}inputs([[ARG_0]] : memref<1x32x16x16xf16, #NHWC, @DDR>) outputs([[VAL19]], [[VAL20]] : [[TYPE19]], [[TYPE20]])
