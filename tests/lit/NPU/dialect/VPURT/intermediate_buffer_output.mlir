...
// RUN: vpux-opt --init-compiler="vpu-arch=%arch% allow-custom-values=true" --intermediate-buffer-output="op-index=5 insertion-index=5 buffer-index=4" %s | FileCheck %s
