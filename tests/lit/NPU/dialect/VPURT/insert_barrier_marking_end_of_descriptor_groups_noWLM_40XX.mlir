...
// CHECK-LABEL: @dontCreateParallelWaitBarriersReuseExisting
// CHECK-SAME: ([[ARG_0:%.+]]: memref<1x3x224x224xf16, @DDR>, [[ARG_1:%.+]]: memref<1x64x112x112xf16, @DDR>)
func.func @dontCreateParallelWaitBarriersReuseExisting(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x112x112xf16, @DDR>) -> memref<1x64x112x112xf16, @DDR> {
    // barriers
    ...
    VPURT.Task updates(%bar1 : !VPURT.Barrier) {
      %49 = VPUIP.NNDMA <{port = 1 : i64}> inputs(%3 : memref<1x3x56x224xf16, {order = #NCHW, strides = [150528, 50176, 224, 1]}, @DDR>) outputs(%11 : memref<1x3x56x224xf16, [@CMX_NN, 0]>) -> memref<1x3x56x224xf16, [@CMX_NN, 0]>
    }
...
// CHECK-LABEL: @dontCreateParallelWaitBarriersReuseExisting2
func.func @dontCreateParallelWaitBarriersReuseExisting2(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x112x112xf16, @DDR>) -> memref<1x64x112x112xf16, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar2 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    ...
    // DMA
    VPURT.Task updates(%bar1, %bar2 : !VPURT.Barrier, !VPURT.Barrier) {
      %49 = VPUIP.NNDMA <{port = 1 : i64}> inputs(%3 : memref<1x3x56x224xf16, {order = #NCHW, strides = [150528, 50176, 224, 1]}, @DDR>) outputs(%11 : memref<1x3x56x224xf16, [@CMX_NN, 0]>) -> memref<1x3x56x224xf16, [@CMX_NN, 0]>
    }
...
// CHECK-LABEL: @cannotReuseBarrierCreateParallelWaitBarriers
func.func @cannotReuseBarrierCreateParallelWaitBarriers(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x112x112xf16, @DDR>) -> memref<1x64x112x112xf16, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar2 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    ...
    //    |       DMA1
    //  DPU1(0)  /
    //  DPU2(0) b1 cannot reuse this barrier. While there's no path DPU4->DPU3,
    //         / | there is path from another consumer of b1 to DPU3 (DPU3 -> DPU3)
    //  DPU3(0)  /
    //     |    /
    //    b2   / new barrier
    //     |  /
    ...
    // DPU4
    // CHECK:       VPURT.Task waits([[BAR1]], [[BAR2]] : !VPURT.Barrier, !VPURT.Barrier) {
    // CHECK-NEXT:         VPUIP.NCEClusterTask
...
// CHECK-LABEL: @insertBarrierAtEndOfExecutionGroupWithGrandChildTaskInDifferentBlock
// CHECK-SAME: ([[ARG_0:%.+]]: memref<1x3x224x224xf16, @DDR>, [[ARG_1:%.+]]: memref<1x64x112x112xf16, @DDR>)
func.func @insertBarrierAtEndOfExecutionGroupWithGrandChildTaskInDifferentBlock(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x112x112xf16, @DDR>) -> memref<1x64x112x112xf16, @DDR> {
    // barriers
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar2 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    ...
    // non-WLM DPU exec groups: [{1,2,3}, {4,5,6}, {7,8,9}]
    //    DMA
    //    |
    //    b0
    //    |
    ...
    // DPU3  (new legalization update barrier inserted at the end of execution group)
    // CHECK:       VPURT.Task updates([[BAR1]] : !VPURT.Barrier) {
    // CHECK-NEXT:         VPUIP.NCEClusterTask
    ...
    // DPU5
    // CHECK:       VPURT.Task waits([[BAR2]] : !VPURT.Barrier) updates([[BAR3]] : !VPURT.Barrier) attributes {"sync-task"} {
    // CHECK-NEXT:         VPUIP.NCEClusterTask
...
// CHECK-LABEL: @legalizeConsecutiveSWtasksWithDepInGrandChildGroup
func.func @legalizeConsecutiveSWtasksWithDepInGrandChildGroup(%arg0: memref<1x3x64x64xf16, @DDR>, %arg1: memref<1x3x64x64xf16, @DDR>) -> memref<1x3x64x64xf16, @DDR> {
    %bar0 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %bar1 = VPURT.DeclareVirtualBarrier -> !VPURT.Barrier
    %buf0 = VPURT.DeclareBuffer <DDR> <0> -> memref<1x3x64x64xf16, @DDR>
    %buf1 = VPURT.DeclareBuffer <DDR> <32> -> memref<1x3x64x64xf16, @DDR>
    ...
    //                DMA
    //        SW0(0)  |
    //        |      b0  wait barrier exists but cannot be reused due to consumers in grand child group
    //        |     / |
    //        SW1(0)  |
    //        |     \/
    //        |     /\
    ...
    //        SW0(0) DMA
    //        |       |
    //        b1     b0  create new parallel wait barrier b1
    //        |     / |
    //        SW1(0)  |
