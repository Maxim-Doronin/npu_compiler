...
//CHECK:        VPUIPDPU.ODUSparsity [[ARG_2]] : memref<1x16x64x64xi1, #NHWC, [@CMX_NN, 0]>
//CHECK:        VPUIPDPU.ODUOutActivations out_activations([[ARG_1]] : memref<1x16x64x64xf16, #NHWC, [@CMX_NN, 0]>) data_width(ODU_DTYPE_16BIT)
