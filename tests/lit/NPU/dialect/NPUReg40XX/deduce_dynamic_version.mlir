...
//CHECK: ELF.CreateSection @note.MappedInferenceVersion
//CHECK:       NPUReg40XX.MappedInferenceVersion(11 _ 7 _ 0)
//CHECK: ELF.CreateSection @program.mapped_inference
//CHECK: "NPUReg40XX.ManagedMappedInference"

// mapped inference version required 11.7, it comes from inference_feature_cfg which has 11.7

//CHECK: VpuManagedMappedInference
//CHECK:             MMI_vpu_nnrt_api_ver = UINT 0xB0007
//CHECK: requires 11:7:0
