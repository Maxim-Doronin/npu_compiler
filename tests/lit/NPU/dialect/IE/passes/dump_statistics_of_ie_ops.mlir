...
module @NonComputationalOps {
    net.NetworkInfo entryPoint : @init inputsInfo : {
        DataInfo "in_ov_1" : tensor<2x1xui8>
        DataInfo "in_ov_2" : tensor<2x1xf16>
    } outputsInfo : {
        DataInfo "out_ov_1" : tensor<2x1xui8>
        DataInfo "out_ov_2" : tensor<1x2xf16>
    }
...
module @ComputationalOps {
    net.NetworkInfo entryPoint : @init inputsInfo : {
        DataInfo "in_ov_1" : tensor<2x1xf32>
        DataInfo "in_ov_2" : tensor<2x1xf16>
    } outputsInfo : {
        DataInfo "out_ov_1" : tensor<10x1xf16>
        DataInfo "out_ov_2" : tensor<2x1xf16>
    }
...
module @WeightsSeparation_InterQuantizedConvert {
    net.NetworkInfo entryPoint : @init inputsInfo : {
        DataInfo "in_ov_1" : tensor<2x1xf16>
    } outputsInfo : {
        DataInfo "out_ov_1" : tensor<2x1xui8>
    }
