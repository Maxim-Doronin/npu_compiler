...
func.func @FuseQParamsIntoAddWithDiffInTypes(%arg0: tensor<1x16x180x320xf16>, %arg1: tensor<1x16x180x320xf16>) -> tensor<1x16x180x320xf16> {
  ...
  //CHECK: [[VAL1:%.+]] = IE.Quantize([[ARG_1]]) {dstElemType = !qElemType1} : tensor<1x16x180x320xf16> -> tensor<1x16x180x320x!qElemType1>
...
// CHECK-SAME:      [[ARG_1:%[^:]+]]: tensor<1x3x16x16xf16>
func.func @DoNotFuseQuantParamsIntoEltwiseMul(%arg0: tensor<1x3x16x16xf16>, %arg1: tensor<1x3x16x16xf16>) -> tensor<1x3x16x16xf16> {
  ...
  // CHECK: [[VAL1:%.+]] = IE.Quantize([[ARG_0]]) {dstElemType = !qElemType} :
  ...
  // CHECK: [[VAL3:%.+]] = IE.Quantize([[ARG_1]]) {dstElemType = !qElemType1} :
...
// CHECK-SAME:      [[ARG_1:%[^:]+]]: tensor<1x3x360x640xf16>
...
// CHECK: @FuseQuantParamsIntoConv([[ARG:%.+]]: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16>
func.func @FuseQuantParamsIntoConv(%arg0: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16> {
  ...
  %4 = IE.Convolution(%2, %3) {dilations = [1, 1], pads_begin = [0, 0], pads_end = [0, 0], post_op = #IE.LeakyRelu<negative_slope = 2.3127431869506836 : f64>, strides = [1, 1]} : tensor<1x3x16x16xf16>, tensor<3x3x3x3xf16> -> tensor<1x3x14x14xf16>
  ...
  //CHECK: [[VAL0:%.+]] = const.Declare tensor<3x3x3x3x[[QTYPE]]> =
  //CHECK-SAME:                 dense<1.000000e+00> : tensor<3x3x3x3xf16>,
  //CHECK-SAME:                 [#const.CastElemType<ui8>, #const.CastElemType<[[QTYPE]]>]

  //CHECK: [[VAL2:%.+]] = IE.Convolution([[VAL1]], [[VAL0]]) {dilations = [1, 1], pads_begin = [0, 0], pads_end = [0, 0], post_op = #IE.LeakyRelu<negative_slope = 2.3127431869506836 : f64>, strides = [1, 1]} : tensor<1x3x16x16x[[QTYPE1]]>, tensor<3x3x3x3x[[QTYPE]]> -> tensor<1x3x14x14x[[QTYPE2]]>
...
// CHECK: @DoNotFuseQuantParamsIntoConv([[ARG:%.+]]: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16>
func.func @DoNotFuseQuantParamsIntoConv(%arg0: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16> {
  ...
  //CHECK: [[VAL4:%.+]] = IE.Convolution([[VAL2]], [[VAL3]]) {dilations = [1, 1], pads_begin = [0, 0], pads_end = [0, 0], post_op = #IE.LeakyRelu<negative_slope = -2.3127431869506836 : f64>, strides = [1, 1]}
...
// CHECK: @DoNotFuseToConvWithInvalidRescaleBias([[ARG:%.+]]: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16>
func.func @DoNotFuseToConvWithInvalidRescaleBias(%arg0: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16> {
  ...
  //CHECK:   [[VAL2:%.+]] = IE.Quantize([[ARG]]) {dstElemType = [[QTYPE1]]}
  //CHECK:   [[VAL3:%.+]] = IE.Dequantize([[VAL2]]) {dstElemType = f16}
  //CHECK:   [[VAL1:%.+]] = const.Declare tensor<3x3x3x3x[[QTYPE]]> = dense<1.000000e+00> : tensor<3x3x3x3xf16>, [#const.CastElemType<ui8>, #const.CastElemType<[[QTYPE]]>]
  //CHECK:   [[VAL0:%.+]] = const.Declare tensor<1x3x1x1xf16> = dense<1.000000e+02> : tensor<1x3x1x1xf16>
  //CHECK:   [[VAL4:%.+]] = IE.Dequantize([[VAL1]]) {dstElemType = f16}
  //CHECK:   [[VAL5:%.+]] = IE.Convolution([[VAL3]], [[VAL4]], [[VAL0]]) {dilations = [1, 1], pads_begin = [0, 0], pads_end = [0, 0], strides = [1, 1]}
  //CHECK:   [[VAL6:%.+]] = IE.Quantize([[VAL5]]) {dstElemType = [[QTYPE2]]}
  //CHECK:   [[VAL7:%.+]] = IE.Dequantize([[VAL6]]) {dstElemType = f16}
...
// CHECK: @DoNotFuseToGroupConvWithInvalidRescaleBias([[ARG]]: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16>
func.func @DoNotFuseToGroupConvWithInvalidRescaleBias(%arg0: tensor<1x3x16x16xf16>) -> tensor<1x3x14x14xf16> {
  ...
  //CHECK:   [[VAL2:%.+]] = IE.Quantize([[ARG]]) {dstElemType = [[QTYPE1]]}
  //CHECK:   [[VAL3:%.+]] = IE.Dequantize([[VAL2]]) {dstElemType = f16}
  //CHECK:   [[VAL1:%.+]] = const.Declare tensor<3x1x3x3x[[QTYPE]]> = dense<1.000000e+00> : tensor<3x1x3x3xf16>, [#const.CastElemType<ui8>, #const.CastElemType<[[QTYPE]]>]
  //CHECK:   [[VAL0:%.+]] = const.Declare tensor<1x3x1x1xf16> = dense<1.000000e+02> : tensor<1x3x1x1xf16>
  //CHECK:   [[VAL4:%.+]] = IE.Dequantize([[VAL1]]) {dstElemType = f16}
  //CHECK:   [[VAL5:%.+]] = IE.GroupConvolution([[VAL3]], [[VAL4]], [[VAL0]]) {dilations = [1, 1], groups = 3 : i64, pads_begin = [0, 0], pads_end = [0, 0], strides = [1, 1]}
  //CHECK:   [[VAL6:%.+]] = IE.Quantize([[VAL5]]) {dstElemType = [[QTYPE2]]}
  //CHECK:   [[VAL7:%.+]] = IE.Dequantize([[VAL6]]) {dstElemType = f16}
