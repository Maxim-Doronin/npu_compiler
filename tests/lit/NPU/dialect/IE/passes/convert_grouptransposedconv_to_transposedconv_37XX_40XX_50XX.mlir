...
// CHECK-LABEL:  @ConvertGroupTransposedConvToTransposedConvDepthwise
// CHECK-SAME:     ([[INPUT:%.+]]: tensor<1x64x64x64xf16>)
...
// CHECK-LABEL:  @ConvertGroupTransposedConvToTransposedConvDepthwiseQuantized
// CHECK-SAME:     ([[INPUT:%.+]]: tensor<1x64x64x64xf16>)
...
// CHECK-LABEL:  @ConvertGroupTransposedConvToTransposedConvDepthwiseQuantizedPerAxis
// CHECK-SAME:     ([[INPUT:%.+]]: tensor<1x64x64x64xf16>)
