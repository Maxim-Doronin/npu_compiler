...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=DefaultHW" --handle-large-pads %s | FileCheck %s
// REQUIRES: platform-NPU3720 || platform-NPU4000 || platform-NPU5010

// -----

// CHECK-LABEL: @HandleLargePadsAvgPool
// CHECK-SAME:      [[ARG_0:%[^:]+]]: tensor<1x16x72x128xf16>
func.func @HandleLargePadsAvgPool(%arg0: tensor<1x16x72x128xf16>) -> tensor<1x16x75x132xf16> {
    ...
    // CHECK:       [[CONCAT0:%.+]] = IE.Concat([[ARG_0]], [[CST_0]]) {per_axis = #IE.Concat<axis = 3 : i64>} : tensor<1x16x72x128xf16>, tensor<1x16x72x4xf16> -> tensor<1x16x72x132xf16>
...
func.func @HandleLargePadsMaxPool(%arg0: tensor<1x16x72x128xf16>) -> tensor<1x16x76x135xf16> {
    ...
    // CHECK:       [[CONCAT0:%.+]] = IE.Concat([[CST_0]], [[ARG_0]], [[CST_1]]) {per_axis = #IE.Concat<axis = 3 : i64>} : tensor<1x16x72x4xf16>, tensor<1x16x72x128xf16>, tensor<1x16x72x3xf16> -> tensor<1x16x72x135xf16>
...
func.func @HandleLargePadsConv(%arg0: tensor<1x16x72x128xf16>) -> tensor<1x32x78x136xf16> {
    ...
    // CHECK:       [[CONCAT0:%.+]] = IE.Concat([[CST_0]], [[ARG_0]], [[CST_1]]) {per_axis = #IE.Concat<axis = 3 : i64>} : tensor<1x16x72x3xf16>, tensor<1x16x72x128xf16>, tensor<1x16x72x5xf16> -> tensor<1x16x72x136xf16>
...
// CHECK-SAME:      [[ARG_0:%[^:]+]]: tensor<1x2x2x96xf16>
func.func @HandleLargePadsGroupConvSmallGroup(%arg0: tensor<1x2x2x96xf16>) -> tensor<1x64x2x96xf16> {
    ...
    // CHECK:       [[CONCAT0:%.+]] = IE.Concat([[ARG_0]]) {per_axis = #IE.Concat<axis = 3 : i64>} : tensor<1x2x2x96xf16> -> tensor<1x2x2x96xf16>
...
// CHECK-LABEL: @HandleLargePadsDepthwiseGroupConv
// CHECK-SAME:      [[INPUT:%.+]]: tensor<1x2048x1024x1xf16>
func.func @HandleLargePadsDepthwiseGroupConv(%arg0: tensor<1x2048x1024x1xf16>) -> tensor<1x2048x1026x1xf16> {
    %weights = const.Declare tensor<2048x1x3x1xf16> = dense<1.0> : tensor<2048x1x3x1xf16>
    %result = IE.GroupConvolution(%arg0, %weights) {
        dilations = [1, 1],
        groups = 2048 : i64,
        pads_begin = [2, 0],
        pads_end = [2, 0],
    ...
    // CHECK-DAG:       [[CST:%.+]] = const.Declare tensor<2048x1x3x1xf16> = dense<1.000000e+00> : tensor<2048x1x3x1xf16>
    // CHECK:       [[CONCAT0:%.+]] = IE.Concat([[INPUT]]) {per_axis = #IE.Concat<axis = 3 : i64>} : tensor<1x2048x1024x1xf16> -> tensor<1x2048x1024x1xf16>
    // CHECK-DAG:       [[CST_0:%.+]] = const.Declare tensor<1x2048x1x1xf16> = dense<0.000000e+00> : tensor<1x2048x1x1xf16>
    // CHECK-DAG:       [[CST_1:%.+]] = const.Declare tensor<1x2048x1x1xf16> = dense<0.000000e+00> : tensor<1x2048x1x1xf16>
    // CHECK:       [[CONCAT1:%.+]] = IE.Concat([[CST_0]], [[CONCAT0]], [[CST_1]]) {per_axis = #IE.Concat<axis = 2 : i64>} : tensor<1x2048x1x1xf16>, tensor<1x2048x1024x1xf16>, tensor<1x2048x1x1xf16> -> tensor<1x2048x1026x1xf16>
    // CHECK:       [[GROUPCONV:%.+]] = IE.GroupConvolution([[CONCAT1]], [[CST]]) {dilations = [1, 1], groups = 2048 : i64, pads_begin = [1, 0], pads_end = [1, 0], strides = [1, 1]} : tensor<1x2048x1026x1xf16>, tensor<2048x1x3x1xf16> -> tensor<1x2048x1026x1xf16>
    // CHECK:        return  [[GROUPCONV]]
}
