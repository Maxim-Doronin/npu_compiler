...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --consolidate-nf4-weights-pattern %s | FileCheck %s
// REQUIRES: platform-NPU3720 || platform-NPU4000 || platform-NPU5010

!quantileType = !QuantileType.quantile<ui4:f16, {-1.000000e+00,-0.71435546875,-0.53564453125,-0.392822265625,-0.28564453125,-0.1785888671875,-0.08929443359375,0.000000e+00,0.080322265625,0.1607666015625,2.500000e-01,0.321533203125,0.428466796875,0.5712890625,0.71435546875,1.000000e+00}>
...
func.func @ConsolidateFP16ActNF4WeightsPattern(%input: tensor<4096x4096xui4>) -> tensor<4096x4096xf16> {
    ...
    // CHECK: [[QUANTCAST:%.+]] = IE.QuantizeCast([[INPUT]]) {dstElemType = !QuantileType.quantile<ui4:f16, {-1.000000e+00,-0.71435546875,-0.53564453125,-0.392822265625,-0.28564453125,-0.1785888671875,-0.08929443359375,0.000000e+00,0.080322265625,0.1607666015625,2.500000e-01,0.321533203125,0.428466796875,0.5712890625,0.71435546875,1.000000e+00}>} : tensor<4096x4096xui4> -> tensor<4096x4096x!QuantileType.quantile<ui4:f16, {-1.000000e+00,-0.71435546875,-0.53564453125,-0.392822265625,-0.28564453125,-0.1785888671875,-0.08929443359375,0.000000e+00,0.080322265625,0.1607666015625,2.500000e-01,0.321533203125,0.428466796875,0.5712890625,0.71435546875,1.000000e+00}>>
...
func.func @ConsolidateF8E4M3FNActNF4WeightsPatternPostConvert(%input: tensor<4096x4096xui4>) -> tensor<4096x4096xf16> {
    ...
    // CHECK: [[SCALE:%.+]] = const.Declare tensor<4096x1xf16> = dense<9.997550e-02> : tensor<4096x1xf16>
    // CHECK: [[QUANTCAST:%.+]] = IE.QuantizeCast([[INPUT]]) {dstElemType = !QuantileType.quantile<ui4:f8E4M3FN, {-1.000000e+00,-6.875000e-01,-5.625000e-01,-4.062500e-01,-2.812500e-01,-1.718750e-01,-8.593750e-02,0.000000e+00,7.812500e-02,1.562500e-01,2.500000e-01,3.125000e-01,4.375000e-01,5.625000e-01,6.875000e-01,1.000000e+00}>} : tensor<4096x4096xui4> -> tensor<4096x4096x!QuantileType.quantile<ui4:f8E4M3FN, {-1.000000e+00,-6.875000e-01,-5.625000e-01,-4.062500e-01,-2.812500e-01,-1.718750e-01,-8.593750e-02,0.000000e+00,7.812500e-02,1.562500e-01,2.500000e-01,3.125000e-01,4.375000e-01,5.625000e-01,6.875000e-01,1.000000e+00}>>
    // CHECK: [[CONVERT_1:%.+]] = IE.Convert([[QUANTCAST]]) {dstElemType = f8E4M3FN} : tensor<4096x4096x!QuantileType.quantile<ui4:f8E4M3FN, {-1.000000e+00,-6.875000e-01,-5.625000e-01,-4.062500e-01,-2.812500e-01,-1.718750e-01,-8.593750e-02,0.000000e+00,7.812500e-02,1.562500e-01,2.500000e-01,3.125000e-01,4.375000e-01,5.625000e-01,6.875000e-01,1.000000e+00}>> -> tensor<4096x4096xf8E4M3FN>
...
func.func @ConsolidateF8E5M2ActNF4WeightsPattern(%input: tensor<4096x4096xui4>) -> tensor<4096x4096xf16> {
    ...
    // CHECK: [[SCALE:%.+]] = const.Declare tensor<4096x1xf16> = dense<9.997550e-02> : tensor<4096x1xf16>
    // CHECK: [[QUANTCAST:%.+]] = IE.QuantizeCast([[INPUT]]) {dstElemType = !QuantileType.quantile<ui4:f8E5M2, {-5.000000e-01,-2.187500e-01,-1.562500e-01,-7.812500e-02,-3.906250e-02,-0.013671875,-0.00341796875,0.000000e+00,0.0029296875,0.01171875,3.125000e-02,4.687500e-02,9.375000e-02,1.562500e-01,2.187500e-01,5.000000e-01}>} : tensor<4096x4096xui4> -> tensor<4096x4096x!QuantileType.quantile<ui4:f8E5M2, {-5.000000e-01,-2.187500e-01,-1.562500e-01,-7.812500e-02,-3.906250e-02,-0.013671875,-0.00341796875,0.000000e+00,0.0029296875,0.01171875,3.125000e-02,4.687500e-02,9.375000e-02,1.562500e-01,2.187500e-01,5.000000e-01}>>
...
func.func @ConsolidateF8E5M2ActNF4WeightsPatternPostConvert(%input: tensor<4096x4096xui4>) -> tensor<4096x4096xf16> {
    ...
    // CHECK: [[SCALE:%.+]] = const.Declare tensor<4096x1xf16> = dense<9.997550e-02> : tensor<4096x1xf16>
    // CHECK: [[QUANTCAST:%.+]] = IE.QuantizeCast([[INPUT]]) {dstElemType = !QuantileType.quantile<ui4:f8E5M2, {-5.000000e-01,-2.187500e-01,-1.562500e-01,-7.812500e-02,-3.906250e-02,-0.013671875,-0.00341796875,0.000000e+00,0.0029296875,0.01171875,3.125000e-02,4.687500e-02,9.375000e-02,1.562500e-01,2.187500e-01,5.000000e-01}>} : tensor<4096x4096xui4> -> tensor<4096x4096x!QuantileType.quantile<ui4:f8E5M2, {-5.000000e-01,-2.187500e-01,-1.562500e-01,-7.812500e-02,-3.906250e-02,-0.013671875,-0.00341796875,0.000000e+00,0.0029296875,0.01171875,3.125000e-02,4.687500e-02,9.375000e-02,1.562500e-01,2.187500e-01,5.000000e-01}>>
    // CHECK: [[CONVERT_1:%.+]] = IE.Convert([[QUANTCAST]]) {dstElemType = f8E5M2} : tensor<4096x4096x!QuantileType.quantile<ui4:f8E5M2, {-5.000000e-01,-2.187500e-01,-1.562500e-01,-7.812500e-02,-3.906250e-02,-0.013671875,-0.00341796875,0.000000e+00,0.0029296875,0.01171875,3.125000e-02,4.687500e-02,9.375000e-02,1.562500e-01,2.187500e-01,5.000000e-01}>> -> tensor<4096x4096xf8E5M2>
