...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --convert-pad-to-concat %s | FileCheck %s
// REQUIRES: platform-NPU3720 || platform-NPU4000 || platform-NPU5010

// CHECK-LABEL: @convertPadToConcatWithN
// CHECK-SAME:    [[ARG_0:%[^:]+]]: tensor<1x8x16x16xf16>
func.func @convertPadToConcatWithN(%arg0: tensor<1x8x16x16xf16>) -> tensor<4x8x16x16xf16> {
    ...
    // CHECK-NOT:      IE.Pad
    // CHECK:       [[VAR0:%.+]] = IE.Concat([[CST0]], [[ARG_0]], [[CST1]]) {per_axis = #IE.Concat<axis = 0 : i64>}
...
func.func @convertPadToConcatWithHW(%arg0: tensor<1x8x16x16xf16>) -> tensor<1x8x19x19xf16> {
    ...
    // CHECK-NOT:      IE.Pad
    // CHECK:       [[VAR0:%.+]] = IE.Concat([[CST0]], [[ARG_0]], [[CST1]]) {per_axis = #IE.Concat<axis = 3 : i64>}
...
// CHECK-SAME:    [[ARG_0:%[^:]+]]: tensor<1x3x297x297xf16>
func.func @convertPadToConcatWithMultiUser(%arg0: tensor<1x3x297x297xf16>) -> (tensor<1x16x300x300xf16>, tensor<1x3x300x300xf16>) {
    ...
    // CHECK-NOT:      IE.Pad
    // CHECK:       [[VAR0:%.+]] = IE.Concat([[CST2]], [[ARG_0]], [[CST3]]) {per_axis = #IE.Concat<axis = 3 : i64>}
...
// CHECK-SAME:    [[ARG_0:%[^:]+]]: tensor<1x96x21499xf16>
func.func @convertPadToConcatWith3DShape(%arg0: tensor<1x96x21499xf16>) -> tensor<1x96x21500xf16> {
    ...
    // CHECK-NOT:      IE.Pad
    // CHECK:       [[VAR0:%.+]] = IE.Concat([[ARG_0]], [[CST0]]) {per_axis = #IE.Concat<axis = 2 : i64>}
...
// CHECK-SAME:    [[ARG_0:%[^:]+]]: tensor<1x16x32x64x128xf16>
func.func @convertPadToConcatWith5DShape(%arg0: tensor<1x16x32x64x128xf16>) -> tensor<1x17x32x64x129xf16> {
    ...
    // CHECK-NOT:      IE.Pad
    // CHECK:       [[CONCAT0:%.+]] = IE.Concat([[ARG_0]], [[CST0]]) {per_axis = #IE.Concat<axis = 4 : i64>}
