...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --dequantize-const="enable-runtime-dequant=true runtime-dequantization-limit=600000" %s | FileCheck %s
