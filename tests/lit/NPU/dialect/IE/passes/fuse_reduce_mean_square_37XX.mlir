...
// CHECK-LABEL: @NoFuseReduceMeanSquare
module @NoFuseReduceMeanSquare {
    ...
    func.func @main(%arg0: tensor<1x32x32x96xf32>) -> tensor<1x32x32x1xf32> {
        ...
        // CHECK-NOT: IE.ReduceMeanSquare
    }
}

// -----

// CHECK-LABEL: @NoFuseReduceMeanSquareWithAdd
module @NoFuseReduceMeanSquareWithAdd {
