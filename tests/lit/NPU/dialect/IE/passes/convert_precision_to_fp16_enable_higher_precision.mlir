...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --convert-precision-to-fp16="compute-layers-with-higher-precision=SoftMax,ReLU,internal_MvnNormalize,Subtract,RandomUniform" %s | FileCheck %s
