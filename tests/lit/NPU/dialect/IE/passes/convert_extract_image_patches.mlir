...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=DefaultHW" --convert-extract-image-patches %s | FileCheck %s
// REQUIRES: platform-NPU3720 || platform-NPU4000 || platform-NPU5010

// CHECK-LABEL: @ConvertExtractImagePatchesTransposeAffineReshapeToSliceConcat
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x6x5xf16>)
func.func @ConvertExtractImagePatchesTransposeAffineReshapeToSliceConcat(%arg0: tensor<1x1x6x5xf16>) -> tensor<1x4x3x5xf16> {
  ...
  //CHECK: [[VAL0:%.+]] = IE.Slice [[ARG_0]] [0, 0, 0, 0] [1, 1, 3, 5] : tensor<1x1x6x5xf16> to tensor<1x1x3x5xf16>
  //CHECK: [[VAL1:%.+]] = IE.Slice [[ARG_0]] [0, 0, 1, 0] [1, 1, 3, 5] : tensor<1x1x6x5xf16> to tensor<1x1x3x5xf16>
  //CHECK: [[VAL2:%.+]] = IE.Slice [[ARG_0]] [0, 0, 2, 0] [1, 1, 3, 5] : tensor<1x1x6x5xf16> to tensor<1x1x3x5xf16>
  //CHECK: [[VAL3:%.+]] = IE.Slice [[ARG_0]] [0, 0, 3, 0] [1, 1, 3, 5] : tensor<1x1x6x5xf16> to tensor<1x1x3x5xf16>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x1x7x4xf16>)
func.func @ConvertExtractImagePatchesTransposeToSliceConcatAffineReshape(%arg0: tensor<1x1x7x4xf16>) -> tensor<1x5x1x12xf16> {
  ...
  //CHECK: [[VAL0:%.+]] = IE.Slice [[ARG_0]] [0, 0, 0, 0] [1, 1, 3, 4] : tensor<1x1x7x4xf16> to tensor<1x1x3x4xf16>
  //CHECK: [[VAL1:%.+]] = IE.Slice [[ARG_0]] [0, 0, 1, 0] [1, 1, 3, 4] : tensor<1x1x7x4xf16> to tensor<1x1x3x4xf16>
  //CHECK: [[VAL2:%.+]] = IE.Slice [[ARG_0]] [0, 0, 2, 0] [1, 1, 3, 4] : tensor<1x1x7x4xf16> to tensor<1x1x3x4xf16>
  //CHECK: [[VAL3:%.+]] = IE.Slice [[ARG_0]] [0, 0, 3, 0] [1, 1, 3, 4] : tensor<1x1x7x4xf16> to tensor<1x1x3x4xf16>
  //CHECK: [[VAL4:%.+]] = IE.Slice [[ARG_0]] [0, 0, 4, 0] [1, 1, 3, 4] : tensor<1x1x7x4xf16> to tensor<1x1x3x4xf16>
...
func.func @NotConvertExtractImagePatchesTransposeToSliceConcatAffineReshape(%arg0: tensor<1x1x7x4xf16>) -> tensor<1x5x12x1xf16> {
  ...
  //CHECK: [[VAL0:%.+]] = IE.ExtractImagePatches([[ARG_0]]) {autoPad = #IE.pad_type<VALID>, rates = [1, 1], sizes = [3, 4], strides = [1, 1]} : tensor<1x1x7x4xf16> -> tensor<1x12x5x1xf16>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x64x51x40xf16>)
func.func @FuseReduceSumExtractImagePatchesReduceSumToReduceSumSqueeze(%arg0: tensor<1x64x51x40xf16>) -> tensor<1x51x1xf16> {
  ...
  //CHECK: [[VAL0:%.+]] = IE.ReduceSum([[ARG_0]]) {axes_value = [1, 3]} : tensor<1x64x51x40xf16> -> tensor<1x51xf16>
...
// CHECK-SAME: ([[ARG_0:%[^:]+]]: tensor<1x8x10x5xf16>)
func.func @FuseReduceSumExtractImagePatchesTransposeReduceSumToReduceSumSqueeze(%arg0: tensor<1x8x10x5xf16>) -> tensor<1x10x1xf16> {
  ...
  //CHECK: [[VAL0:%.+]] = IE.ReduceSum([[ARG_0]]) {axes_value = [1, 3]} : tensor<1x8x10x5xf16> -> tensor<1x10xf16>
...
func.func @ConvertExtractImagePatchesToTranspose(%arg0: tensor<1x16x8x12xf16>) -> tensor<1x12x8x1xf16> {
  ...
  //CHECK: [[VAL0:%.+]] = IE.ReduceSum([[ARG_0]]) {axes_value = [1], keep_dims} : tensor<1x16x8x12xf16> -> tensor<1x1x8x12xf16>
