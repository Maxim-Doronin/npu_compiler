...
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=%arch% allow-custom-values=true" --run-mem-permute-processing-rewriters="rewriter=optimize-concat-with-conv-set" %s | FileCheck %s
