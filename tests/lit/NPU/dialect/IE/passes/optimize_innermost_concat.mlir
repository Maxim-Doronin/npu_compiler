...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --run-mem-permute-processing-rewriters="rewriter=optimize-innermost-concat-set" %s | FileCheck %s
