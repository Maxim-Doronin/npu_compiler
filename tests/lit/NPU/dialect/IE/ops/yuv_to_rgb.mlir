...
func.func @ConvertToMultiInputs(%arg0: tensor<1x552x432x1xf16>) ->  tensor<1x368x432x3xf16>  {
    ...
    //CHECK: [[LUMA:%.+]] = IE.Slice [[ARG_0]] [0, 0, 0, 0] [1, 368, 432, 1] : tensor<1x552x432x1xf16> to tensor<1x368x432x1xf16>
    //CHECK: [[CHROMA:%.+]] = IE.Slice [[ARG_0]] [0, 368, 0, 0] [1, 184, 432, 1] : tensor<1x552x432x1xf16> to tensor<1x184x432x1xf16>
