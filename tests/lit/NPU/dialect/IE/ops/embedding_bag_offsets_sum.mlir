...
// CHECK-SAME:    ([[ARG_0:%[^:]+]]: tensor<5x6xf16>)
func.func @ConvertConstToAttr(%arg0: tensor<5x6xf16>) -> tensor<2x6xf16> {
    ...
    // CHECK: [[VAR0:%.+]] = IE.EmbeddingBagOffsetsSum([[ARG_0]], [[CST]], [[CST0]], [[CST1]]) {default_index_value = 0 : i32, operandSegmentSizes = array<i32: 1, 1, 1, 0, 1>} : tensor<5x6xf16>, tensor<5xsi32>, tensor<2xsi32>, tensor<5xf16> -> tensor<2x6xf16>
