...
func.func @ComposeStridedSlices(%arg0: tensor<1x3x640x640xf16>) -> tensor<1x12x320x320xf16> {
    ...
    // CHECK:     [[SLICE_1:%.+]] = IE.StridedSlice([[ARG_0]]) {begin_mask = [0, 0, 0, 0], begins_attr = [0, 0, 0, 0], ellipsis_mask = [0, 0, 0, 0], end_mask = [0, 0, 0, 0], ends_attr = [1, 3, 640, 640], new_axis_mask = [0, 0, 0, 0], operandSegmentSizes = array<i32: 1, 0, 0, 0>, shrink_axis_mask = [0, 0, 0, 0], strides_attr = [1, 1, 2, 2]} : tensor<1x3x640x640xf16> -> tensor<1x3x320x320xf16>
    // CHECK:     [[SLICE_2:%.+]] = IE.StridedSlice([[ARG_0]]) {begin_mask = [0, 0, 0, 0], begins_attr = [0, 0, 1, 0], ellipsis_mask = [0, 0, 0, 0], end_mask = [0, 0, 0, 0], ends_attr = [1, 3, 641, 640], new_axis_mask = [0, 0, 0, 0], operandSegmentSizes = array<i32: 1, 0, 0, 0>, shrink_axis_mask = [0, 0, 0, 0], strides_attr = [1, 1, 2, 2]} : tensor<1x3x640x640xf16> -> tensor<1x3x320x320xf16>
    // CHECK:     [[SLICE_3:%.+]] = IE.StridedSlice([[ARG_0]]) {begin_mask = [0, 0, 0, 0], begins_attr = [0, 0, 0, 1], ellipsis_mask = [0, 0, 0, 0], end_mask = [0, 0, 0, 0], ends_attr = [1, 3, 640, 640], new_axis_mask = [0, 0, 0, 0], operandSegmentSizes = array<i32: 1, 0, 0, 0>, shrink_axis_mask = [0, 0, 0, 0], strides_attr = [1, 1, 2, 2]} : tensor<1x3x640x640xf16> -> tensor<1x3x320x320xf16>
    // CHECK:     [[SLICE_4:%.+]] = IE.StridedSlice([[ARG_0]]) {begin_mask = [0, 0, 0, 0], begins_attr = [0, 0, 1, 1], ellipsis_mask = [0, 0, 0, 0], end_mask = [0, 0, 0, 0], ends_attr = [1, 3, 641, 640], new_axis_mask = [0, 0, 0, 0], operandSegmentSizes = array<i32: 1, 0, 0, 0>, shrink_axis_mask = [0, 0, 0, 0], strides_attr = [1, 1, 2, 2]} : tensor<1x3x640x640xf16> -> tensor<1x3x320x320xf16>
...
func.func @ComposeStridedSlicesOneStridedSliceConnectToTwoStridedSlice(%arg0: tensor<1x3x416x416xf16>) -> tensor<1x12x208x208xf16> {
    ...
    // CHECK:     [[FQ:%.+]] = IE.FakeQuantize([[ARG_0]], [[CST_1]], [[CST_0]], [[CST_1]], [[CST_0]]) {auto_broadcast = #IE.auto_broadcast_type<NUMPY>, levels = 256 : i64} : tensor<1x3x416x416xf16>, tensor<1x1x1x1xf16>, tensor<1x1x1x1xf16>, tensor<1x1x1x1xf16>, tensor<1x1x1x1xf16> -> tensor<1x3x416x416xf16>
