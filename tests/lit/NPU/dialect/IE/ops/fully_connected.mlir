...
func.func @UseFullyConnected(%arg0: tensor<1x16xf32>) -> tensor<1x64xf32> {
    ...
    // CHECK:       [[VAL0:%.+]] = IE.FullyConnected([[ARG_0]], [[WEIGHTS]]) : tensor<1x16xf32>, tensor<64x16xf32> -> tensor<1x64xf32>
    // CHECK-NOT:   IE.MatMul
    // CHECK:       return [[VAL0]]
}
...
func.func @FuseFCAndBias(%arg0: tensor<1x16xf32>) -> tensor<1x64xf32> {
    ...
    // CHECK:       [[VAL0:%.+]] = IE.FullyConnected([[ARG_0]], [[WEIGHTS]], [[BIAS]])
    // CHECK:       return [[VAL0]]
}
...
// CHECK-SAME:    ([[ARG_0:%[^:]+]]: tensor<1x512xf32>)
func.func @UseFullyConnectedWithTransposedWeights(%arg0: tensor<1x512xf32>) -> tensor<1x40xf32> {
    ...
    // CHECK:       [[FC_OUT:%.+]] = IE.FullyConnected([[ARG_0]], [[WEIGHTS]]) : tensor<1x512xf32>, tensor<40x512xf32> -> tensor<1x40xf32>
