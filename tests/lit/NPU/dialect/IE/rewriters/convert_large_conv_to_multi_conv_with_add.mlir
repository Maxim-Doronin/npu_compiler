...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --run-adjust-for-vpu-rewriters="rewriter=convert-large-conv-to-multi-conv-with-add" %s | FileCheck %s
