...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=HostCompile" --optimize-concat="disable-pass-on-entry-function=true" %s | FileCheck %s
