...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true" --scf-vertical-fusion="enable-dynamic-dim-alignment=true" --resolve-shaped-type-result-dims --canonicalize --cse %s | FileCheck %s
