...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% compilation-mode=DefaultHW" --detection-output-decomposition --mlir-elide-elementsattrs-if-larger 32 %s | FileCheck %s
