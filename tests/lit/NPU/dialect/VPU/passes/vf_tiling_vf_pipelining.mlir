...
func.func @VfTilingWithSwish(%arg0: tensor<1x16x176x176x!quant.uniform<u8:f16, 0.14376571505677466:128>, {order = #NHWC}>, %cst_1: tensor<96x16x1x1x!qElemType1, {order = #NHWC}>, %cst_3: tensor<96x16x1x1xf16, {order = #NHWC}>) -> tensor<1x96x176x176x!qElemType2, {order = #NHWC}>  {
   ...
   // CHECK: [[CONV0:%.+]] = VPU.NCE.Convolution([[SLICE0]], [[ARG_1]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 16, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 0 : i64}
   // CHECK-SAME: -> tensor<1x96x44x176xf16, {order = #NHWC}>

   // CHECK: [[SWISH0:%.+]] = VPU.Swish([[CONV0]]) {beta_value = 1.000000e+00 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, vf_loop_index = 0 : i64, vf_loop_layer_index = 0 : i64} : tensor<1x96x44x176xf16, {order = #NHWC}> -> tensor<1x96x44x176xf16, {order = #NHWC}>
   ...
   // CHECK: [[CONV1:%.+]] = VPU.NCE.Convolution([[SLICE1]], [[ARG_1]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 16, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 1 : i64}
   // CHECK-SAME: -> tensor<1x96x44x176xf16, {order = #NHWC}>
   // CHECK: [[DEPTHCONV0:%.+]] = VPU.NCE.DepthConvolution([[SWISH0]], [[ARG_2]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 1, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 0 : i64} -> tensor<1x96x44x176x!qElemType2, {order = #NHWC}>

   // CHECK: [[SWISH1:%.+]] = VPU.Swish([[CONV1]]) {beta_value = 1.000000e+00 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, vf_loop_index = 0 : i64, vf_loop_layer_index = 1 : i64} : tensor<1x96x44x176xf16, {order = #NHWC}> -> tensor<1x96x44x176xf16, {order = #NHWC}>
   ...
   // CHECK: [[CONV2:%.+]] = VPU.NCE.Convolution([[SLICE2]], [[ARG_1]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 16, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 2 : i64}
   // CHECK-SAME: -> tensor<1x96x44x176xf16, {order = #NHWC}>
   // CHECK: [[DEPTHCONV1:%.+]] = VPU.NCE.DepthConvolution([[SWISH1]], [[ARG_2]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 1, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 1 : i64} -> tensor<1x96x44x176x!qElemType2, {order = #NHWC}>

   // CHECK: [[SWISH2:%.+]] = VPU.Swish([[CONV2]]) {beta_value = 1.000000e+00 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, vf_loop_index = 0 : i64, vf_loop_layer_index = 2 : i64} : tensor<1x96x44x176xf16, {order = #NHWC}> -> tensor<1x96x44x176xf16, {order = #NHWC}>
   ...
   // CHECK: [[CONV3:%.+]] = VPU.NCE.Convolution([[SLICE3]], [[ARG_1]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 16, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 3 : i64}
   // CHECK-SAME: -> tensor<1x96x44x176xf16, {order = #NHWC}>
   // CHECK: [[DEPTHCONV2:%.+]] = VPU.NCE.DepthConvolution([[SWISH2]], [[ARG_2]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 1, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 2 : i64} -> tensor<1x96x44x176x!qElemType2, {order = #NHWC}>

   // CHECK: [[SWISH3:%.+]] = VPU.Swish([[CONV3]]) {beta_value = 1.000000e+00 : f64, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, vf_loop_index = 0 : i64, vf_loop_layer_index = 3 : i64} : tensor<1x96x44x176xf16, {order = #NHWC}> -> tensor<1x96x44x176xf16, {order = #NHWC}>

   // CHECK: [[DEPTHCONV3:%.+]] = VPU.NCE.DepthConvolution([[SWISH3]], [[ARG_2]]) {multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [96, 1, 1, 1], strides = [1, 1], vf_loop_index = 0 : i64, vf_loop_layer_index = 3 : i64} -> tensor<1x96x44x176x!qElemType2, {order = #NHWC}>
