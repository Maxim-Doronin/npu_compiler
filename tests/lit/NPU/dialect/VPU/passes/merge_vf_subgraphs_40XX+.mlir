...
func.func @MergeConvertWithConvolution(%arg0: tensor<1x16x1600x2560xf32, {order = #NHWC}>) -> tensor<1x32x800x1280xf16, {order = #NHWC}> {
  ...
  %1 = VPU.VerticalFusion (%0 as %arg1: tensor<1x16x1600x2560xf16, {order = #NHWC}>,
    ...
    %26 = VPU.NCE.Convolution(%arg1, %arg2) {mpe_engine = #VPU.MPEEngine37XX<mode = <SCL>>, multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverHeight>, output_padding = [0, 0, 0, 0], pad = #VPU.Padding<left = 1 : i64, right = 0 : i64, top = 1 : i64, bottom = 0 : i64>, ppe = #VPU.PPEStub<>, rawFilterShape = [32, 16, 3, 3], strides = [2, 2]}
      : tensor<1x16x1600x2560xf16, {order = #NHWC}>,
...
func.func @FuseBlocksWithPermuteCast(%arg0: tensor<1x2x320x4096xf16>) -> tensor<1x320x2x4096xf16, {order = #NHWC}> {
  ...
  %3 = VPU.VerticalFusion (%0 as %arg1: tensor<1x4096x2x320xf16, {order = #NHCW}>,
    ...
    %5 = VPU.NCE.DepthConvolution(%4, %arg2) {
      multiClusterStrategy = #VPU.multi_cluster_strategy<SplitOverKernel>,
      pad = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>,
      ppe = #VPU.PPEStub<>, rawFilterShape = [320, 1, 1, 1], strides = [1, 1]
    } -> tensor<1x320x2x4096xf16, {order = #NHWC}>
    VPU.Yield %5
  }
