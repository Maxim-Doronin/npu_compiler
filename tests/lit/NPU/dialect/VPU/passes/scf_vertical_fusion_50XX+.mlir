...
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=%arch% allow-custom-values=true enable-is-reduce-supported" --scf-vertical-fusion --resolve-shaped-type-result-dims --canonicalize %s | FileCheck %s
