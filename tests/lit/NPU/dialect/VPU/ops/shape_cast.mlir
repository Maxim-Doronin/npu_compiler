...
func.func @FuseSequence(%arg0 : tensor<1x2x3x4xf16>) -> tensor<1x4x3x2xf16> {
    ...
    // CHECK:       [[SHAPE_CAST:%.+]] = VPU.ShapeCast {shape = [1, 4, 3, 2]} inputs([[ARG_0]] : tensor<1x2x3x4xf16>) -> tensor<1x4x3x2xf16>
    ...
    (tensor<1x3x2x4xf16>, tensor<1x3x4x2xf16, { order = #NCWH }>)
{
    ...
    // CHECK: [[SHAPECAST:%.+]] = VPU.ShapeCast {shape = [1, 3, 2, 4]} inputs([[ARG_0]] : tensor<1x2x3x4xf16>) -> tensor<1x3x2x4xf16>
