...
module @TestConvolution {
  ...
  func.func @main(%arg0: memref<1x16x16x16xf16, @DDR>, %arg1: memref<1x16x14x14xf16, @DDR>) -> memref<1x16x14x14xf16, @DDR> {
    ...
    input(%6 : memref<1x16x16x16xf16, #NHWC, [@CMX_NN, 0]>) weights(%6 : memref<1x16x16x16xf16, #NHWC, [@CMX_NN, 0]>) outputs(%3 : memref<1x16x16x16xf16, #NWCH, [@CMX_NN, 0]>)
    ...
    previousTask(%17 : !VPURegMapped.Index<0:0:0>) input(%7 : memref<1x16x16x16xf16, #NHWC, [@CMX_NN, 0]>) weights(%9 : memref<16x16x3x3xf16, #NHWC, [@CMX_NN, 0]>)
...
module @Convolution attributes {config.compilationMode = #config.compilation_mode<DefaultHW>} {
  ...
  func.func @main(%arg0: memref<1x32x16x16xf16, @DDR>, %arg1: memref<1x32x14x14xf16, @DDR>) -> memref<1x32x14x14xf16, @DDR> {
    ...
    %102 = VPUMI40XX.DPUInvariant <{clean_after = 0 : ui64, mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<ELTWISE>, start_after = 0 : ui64}>
     input(%43 : memref<1x16x32x2xf16, #NHWC, [@CMX_NN, 5]>) weights(%37 : memref<1x16x32x2xf16, #NHWC, [@CMX_NN, 5]>) outputs(%73 : memref<1x16x32x4xf16, {order = #NWCH}, [@CMX_NN, 5]>)
    ...
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%97 : !VPURegMapped.Index<0:0:0>) input(%44 : memref<1x32x5x16xf16, #NHWC, [@CMX_NN, 0]>) weights(%56 : memref<32x32x3x3xf16, #NHWC, [@CMX_NN, 0]>)
    ...
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%98 : !VPURegMapped.Index<1:0:0>) input(%45 : memref<1x32x5x16xf16, #NHWC, [@CMX_NN, 1]>) weights(%57 : memref<32x32x3x3xf16, #NHWC, [@CMX_NN, 1]>)
    ...
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%99 : !VPURegMapped.Index<2:0:0>) input(%46 : memref<1x32x4x16xf16, #NHWC, [@CMX_NN, 2]>) weights(%58 : memref<32x32x3x3xf16, #NHWC, [@CMX_NN, 2]>)
    ...
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%100 : !VPURegMapped.Index<3:0:0>) input(%47 : memref<1x32x4x16xf16, #NHWC, [@CMX_NN, 3]>) weights(%59 : memref<32x32x3x3xf16, #NHWC, [@CMX_NN, 3]>)
    ...
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%101 : !VPURegMapped.Index<4:0:0>) input(%48 : memref<1x32x4x16xf16, #NHWC, [@CMX_NN, 4]>) weights(%60 : memref<32x32x3x3xf16, #NHWC, [@CMX_NN, 4]>)
    ...
    kernel_strides = [1, 1], mpe_frequent_mode = #VPU.mpe_mode<CUBOID_16x16>, nce_task_type = #VPUIP.nce_task_type<CONV>, start_after = 0 : ui64}>
    previousTask(%102 : !VPURegMapped.Index<5:0:0>) input(%49 : memref<1x32x4x16xf16, #NHWC, [@CMX_NN, 5]>) weights(%61 : memref<32x32x3x3xf16, #NHWC, [@CMX_NN, 5]>)
