...
module @FetchWithEnqueueTarget {
  ...
  func.func @FetchWithEnqueueTarget(%arg0: memref<1x3x224x224xf16, @DDR>, %arg1: memref<1x64x56x56xf16, @DDR>) -> memref<1x64x56x56xf16, @DDR> {
    ...
    %39 = VPUMI40XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 0 : i64, len = 0 : i64, srcWidth = 0 : i64, srcStride = 0 : i64, srcPlaneStride = 0 : i64, dstWidth = 0 : i64, dstStride = 0 : i64, dstPlaneStride = 0 : i64>, fetch_dma = #VPUIP.FetchDMAAttr<<DPU>, tile = 0 : i64, list = 0 : i64, group = 0 : i64>, port = 0 : i64, wlmPage = 0 : i64}> inputs(%7 : memref<0x0x0x0xi32, @DDR>) outputs(%8 : memref<0x0x0x0xi32, @DDR>) previousDMA(%38 : !VPURegMapped.Index<0:0:1>) updates(%24 : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:2>
    %40 = VPUMI40XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 0 : i64, len = 0 : i64, srcWidth = 0 : i64, srcStride = 0 : i64, srcPlaneStride = 0 : i64, dstWidth = 0 : i64, dstStride = 0 : i64, dstPlaneStride = 0 : i64>, fetch_dma = #VPUIP.FetchDMAAttr<<DPU>, tile = 0 : i64, list = 0 : i64, group = 1 : i64>, port = 0 : i64, wlmPage = 0 : i64}> inputs(%7 : memref<0x0x0x0xi32, @DDR>) outputs(%8 : memref<0x0x0x0xi32, @DDR>) previousDMA(%39 : !VPURegMapped.Index<0:0:2>) updates(%24 : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:3>
    ...
    %44 = VPUMI40XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 0 : i64, len = 0 : i64, srcWidth = 0 : i64, srcStride = 0 : i64, srcPlaneStride = 0 : i64, dstWidth = 0 : i64, dstStride = 0 : i64, dstPlaneStride = 0 : i64>, fetch_dma = #VPUIP.FetchDMAAttr<<DPU>, tile = 0 : i64, list = 0 : i64, group = 2 : i64>, port = 0 : i64, wlmPage = 1 : i64}> inputs(%7 : memref<0x0x0x0xi32, @DDR>) outputs(%8 : memref<0x0x0x0xi32, @DDR>) previousDMA(%43 : !VPURegMapped.Index<0:0:6>) waits(%27 : !VPURegMapped.Index<0:0:4>) updates(%28 : !VPURegMapped.Index<0:0:5>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:7>
    %45 = VPUMI40XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 0 : i64, len = 0 : i64, srcWidth = 0 : i64, srcStride = 0 : i64, srcPlaneStride = 0 : i64, dstWidth = 0 : i64, dstStride = 0 : i64, dstPlaneStride = 0 : i64>, fetch_dma = #VPUIP.FetchDMAAttr<<DPU>, tile = 0 : i64, list = 0 : i64, group = 3 : i64>, port = 0 : i64, wlmPage = 1 : i64}> inputs(%7 : memref<0x0x0x0xi32, @DDR>) outputs(%8 : memref<0x0x0x0xi32, @DDR>) previousDMA(%44 : !VPURegMapped.Index<0:0:7>) waits(%29 : !VPURegMapped.Index<0:0:6>) updates(%30 : !VPURegMapped.Index<0:0:7>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:8>
    %46 = VPUMI40XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 0 : i64, len = 0 : i64, srcWidth = 0 : i64, srcStride = 0 : i64, srcPlaneStride = 0 : i64, dstWidth = 0 : i64, dstStride = 0 : i64, dstPlaneStride = 0 : i64>, fetch_dma = #VPUIP.FetchDMAAttr<<DPU>, tile = 0 : i64, list = 0 : i64, group = 4 : i64>, port = 0 : i64, wlmPage = 2 : i64}> inputs(%7 : memref<0x0x0x0xi32, @DDR>) outputs(%8 : memref<0x0x0x0xi32, @DDR>) previousDMA(%45 : !VPURegMapped.Index<0:0:8>) waits(%31 : !VPURegMapped.Index<0:0:8>) updates(%32 : !VPURegMapped.Index<0:0:9>) enqueueBarrier(%24 : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:9>
    %47 = VPUMI40XX.NNDMA <{dma_descriptor = #VPUIP.DMADescriptorAttr<numPlanes = 0 : i64, len = 0 : i64, srcWidth = 0 : i64, srcStride = 0 : i64, srcPlaneStride = 0 : i64, dstWidth = 0 : i64, dstStride = 0 : i64, dstPlaneStride = 0 : i64>, fetch_dma = #VPUIP.FetchDMAAttr<<DPU>, tile = 0 : i64, list = 0 : i64, group = 5 : i64>, port = 0 : i64, wlmPage = 2 : i64}> inputs(%7 : memref<0x0x0x0xi32, @DDR>) outputs(%8 : memref<0x0x0x0xi32, @DDR>) previousDMA(%46 : !VPURegMapped.Index<0:0:9>) waits(%33 : !VPURegMapped.Index<0:0:10>) updates(%34 : !VPURegMapped.Index<0:0:11>) enqueueBarrier(%24 : !VPURegMapped.Index<0:0:1>) start_after(0) clean_after(0) acceleration_mode(<DISABLE>) -> !VPURegMapped.Index<0:0:10>
  ...
  // CHECK: [[ENQ_BAR:%.+]] = VPUMI40XX.ConfigureBarrier <{consumer_count = 2 : ui8, producer_count = 2 : ui8, wlmPage = 0 : i64}>(%23 : !VPURegMapped.Index<0:0:0>) <1, -1> -> !VPURegMapped.Index<0:0:1>
  // Fetch Group 0
