...
// RUN: vpux-opt --split-input-file --init-compiler="vpu-arch=%arch%" --mlir-print-elementsattrs-with-hex-if-larger=-1 --unroll-cluster-tiling --canonicalize --constant-folding %s | FileCheck %s
