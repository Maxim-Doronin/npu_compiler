...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform%" --satisfy-one-wait-barrier-per-task="max-variant-count=8 merge-wait-barriers-iteratively=1" %s | FileCheck %s
