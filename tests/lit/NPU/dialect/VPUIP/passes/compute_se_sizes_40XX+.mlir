...
func.func @ConvSETableNoSM(%input: memref<1x32x56x56xf16, #NHWC, [@CMX_NN, 0]>,
    ...
    VPURT.Task {
        %1 = VPUIP.NCEClusterTask <{kernel_padding = #VPU.Padding<left = 0 : i64, right = 0 : i64, top = 0 : i64, bottom = 0 : i64>, kernel_size = [1, 1], kernel_strides = [1, 1], out_channel_offset = 0 : i64, task_type = #VPUIP.nce_task_type<CONV>}>
