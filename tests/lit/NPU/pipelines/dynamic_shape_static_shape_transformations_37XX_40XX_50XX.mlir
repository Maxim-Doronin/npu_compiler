...
// RUN: vpux-opt --split-input-file --init-compiler="platform=%platform% allow-custom-values=true enable-extra-static-shape-ops=false" --dynamic-shape-transformations %s | FileCheck %s
