...
INSTANTIATE_TEST_SUITE_P(
        ...
        testing::Values(
                ...
                AutoBatchCompilerCfgValidationParams{"batch-compile-method=debatch "
                                                     "debatcher-settings={debatcher-input-coefficients-partitions=[0-2]"
                                                     ",[0-2],[0-1], debatching-inlining-method=naive} "
                                                     "NON-RECOGNIZABLE-OPTION=NON_RECOGNIZABLE-VALUE",
                                                     true},
                AutoBatchCompilerCfgValidationParams{
                        "NON-RECOGNIZABLE-OPTION_BEGIN=NON_RECOGNIZABLE-VALUE_BEGIN batch-compile-method=debatch "
                        "debatcher-settings={debatcher-input-coefficients-partitions=[0-2]"
                        ",[0-2],[0-1], debatching-inlining-method=naive} "
                        "NON-RECOGNIZABLE-OPTION_END=NON_RECOGNIZABLE-VALUE_END",
                        true},
                ...
                AutoBatchCompilerCfgValidationParams{"debatcher-settings={debatcher-input-coefficients-partitions=[0-2]"
                                                     ",[0-2],[0-1], debatching-inlining-method=naive}",
                                                     false},
                AutoBatchCompilerCfgValidationParams{"NON-RECOGNIZABLE-OPTION_BEGIN=NON_RECOGNIZABLE-VALUE_BEGIN "
                                                     "debatcher-settings={debatcher-input-coefficients-partitions=[0-2]"
                                                     ",[0-2],[0-1], debatching-inlining-method=naive} "
                                                     "NON-RECOGNIZABLE-OPTION_END=NON_RECOGNIZABLE-VALUE_END",
                                                     false}),
