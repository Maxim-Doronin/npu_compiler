...
set(PKG_CONFIG_EXECUTABLE "${OECORE_HOST_SYSROOT}/usr/bin/x86_64-esesdk-linux-gnu-pkg-config" CACHE PATH "Path to yocto pkg-config")
set(PKG_CONFIG_PATH "${OECORE_TARGET_SYSROOT}/usr/lib/pkgconfig:${OECORE_TARGET_SYSROOT}/usr/share/pkgconfig" CACHE STRING "PKG_CONFIG_PATH for yocto")
set(PKG_CONFIG_SYSROOT_DIR "${OECORE_TARGET_SYSROOT}" CACHE STRING "PKG_CONFIG_SYSROOT_DIR for yocto")
