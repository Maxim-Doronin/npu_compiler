...
namespace std {
template <>
class numeric_limits<vpux::type::bfloat16> {
public:
    static constexpr bool is_specialized = true;
    static constexpr vpux::type::bfloat16 min() noexcept {
        return vpux::type::bfloat16::from_bits(0x007F);
    }
    static constexpr vpux::type::bfloat16 max() noexcept {
        return vpux::type::bfloat16::from_bits(0x7F7F);
    }
    static constexpr vpux::type::bfloat16 lowest() noexcept {
        return vpux::type::bfloat16::from_bits(0xFF7F);
    }
    ...
    static constexpr vpux::type::bfloat16 epsilon() noexcept {
        return vpux::type::bfloat16::from_bits(0x3C00);
    }
    static constexpr vpux::type::bfloat16 round_error() noexcept {
        return vpux::type::bfloat16::from_bits(0x3F00);
    }
    ...
    static constexpr vpux::type::bfloat16 infinity() noexcept {
        return vpux::type::bfloat16::from_bits(0x7F80);
    }
    static constexpr vpux::type::bfloat16 quiet_NaN() noexcept {
        return vpux::type::bfloat16::from_bits(0x7FC0);
    }
    static constexpr vpux::type::bfloat16 signaling_NaN() noexcept {
        return vpux::type::bfloat16::from_bits(0x7FC0);
    }
    static constexpr vpux::type::bfloat16 denorm_min() noexcept {
