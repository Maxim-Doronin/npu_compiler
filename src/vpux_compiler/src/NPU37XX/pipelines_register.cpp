...
void PipelineRegistry37XX::registerPipelines() {
    mlir::PassPipelineRegistration<DefaultHWOptions37XX>(
            ...
            [](mlir::OpPassManager& pm, const DefaultHWOptions37XX& options) {
                VPU::InitCompilerOptions initCompilerOptions{VPU::ArchKind::NPU37XX, VPU::CompilationMode::ShaveCodeGen,
                                                             options};
    ...
    mlir::PassPipelineRegistration<ReferenceSWOptions37XX>(
            ...
            [](mlir::OpPassManager& pm, const ReferenceSWOptions37XX& options) {
                VPU::InitCompilerOptions initCompilerOptions{VPU::ArchKind::NPU37XX, VPU::CompilationMode::ReferenceSW,
                                                             options};
                auto createPipelineStartegy = [&](VPU::CompilationMode) {
    ...
    mlir::PassPipelineRegistration<DefaultHWOptions37XX>(
            ...
            [](mlir::OpPassManager& pm, const DefaultHWOptions37XX& options) {
                VPU::InitCompilerOptions initCompilerOptions{VPU::ArchKind::NPU37XX, VPU::CompilationMode::DefaultHW,
                                                             options};
                auto createPipelineStartegy = [&](VPU::CompilationMode) {
                    return createDialectPipelineStrategy37XX<DefaultHWOptions37XX>(&initCompilerOptions, &options);
                };
