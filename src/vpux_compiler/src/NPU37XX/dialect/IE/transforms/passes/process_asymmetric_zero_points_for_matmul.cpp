...
class ProcessAsymmetricZeroPointsForMatmulPass final :
        public IE::arch37xx::impl::ProcessAsymmetricZeroPointsForMatmulBase<ProcessAsymmetricZeroPointsForMatmulPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::IE::arch37xx::createProcessAsymmetricZeroPointsForMatmulPass(
