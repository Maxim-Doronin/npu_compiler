...
class WrapFuncCallsIntoAsyncRegionsPass final :
        public HostExec::impl::WrapFuncCallsIntoAsyncRegionsBase<WrapFuncCallsIntoAsyncRegionsPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::HostExec::createWrapFuncCallsIntoAsyncRegionsPass(Logger log) {
