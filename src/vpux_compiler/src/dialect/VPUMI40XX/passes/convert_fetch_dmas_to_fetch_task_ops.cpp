...
public:
    explicit ConvertFetchDmasToFetchTaskOpsPass(Logger log): _log(log) {
    }
...
void ConvertFetchDmasToFetchTaskOpsPass::safeRunOnFunc() {
    ...
    VPUMI40XX::reindexList<VPURegMapped::FetchTaskOp>(mpi, firstFetch, DMA_WLM_TILEIDX, DMA_DDR2CMX_LISTIDX);
