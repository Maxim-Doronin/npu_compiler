...
mlir::LogicalResult PermuteDMARewriter::matchAndRewrite(VPUIP::PermuteDMAOp permuteOp,
    ...
    return arch40xx::rewritePermuteDMA(permuteOp, rewriter, _dmaPortCount, _log);
}
...
class UnrollPermuteDMAPass final : public VPUIP::arch40xx::impl::UnrollPermuteDMABase<UnrollPermuteDMAPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPUIP::arch40xx::createUnrollPermuteDMAPass(Logger log) {
