...
class WlmInsertDummyBarriersInPagesPass final :
        public VPURT::arch40xx::impl::WlmInsertDummyBarriersInPagesBase<WlmInsertDummyBarriersInPagesPass> {
public:
...
std::unique_ptr<mlir::Pass> vpux::VPURT::arch40xx::createWlmInsertDummyBarriersInPagesPass(Logger log) {
