...
class StrategyFactory50XX : public VPUIP::StrategyFactory {
public:
...
void vpux::VPUIP::StrategiesInitializer50XX::initialize(mlir::MLIRContext* context) {
    auto factory = std::make_unique<VPUIP::StrategyFactory50XX>();
