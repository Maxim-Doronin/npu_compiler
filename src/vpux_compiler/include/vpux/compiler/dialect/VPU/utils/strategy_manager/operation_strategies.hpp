...
public:
    ...
    */
    ...
    /*
       ...
       If the cost hasn't been set, function returns std::nullopt
    */
    std::optional<StrategyCost> getTransitionCost(const OperationStrategy& srcOpStr,
    ...
    */
    ...
    /*
       Get all operations in the storage
    */
    llvm::SetVector<mlir::Operation*> getAllOperations() const;

    /*
       Get all strategies of the operation
    */
    SmallVector<StrategyInfo> getAllStrategies(mlir::Operation* operation) const;
...
private:
    ...
    */
    ...
    llvm::SetVector<mlir::Operation*> _operationList;
};
